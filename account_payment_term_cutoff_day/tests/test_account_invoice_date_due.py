...
class TestPaymentTermCutoffDate(TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.payment_term_line.write(
            {"value": "balance", "months": 1, "end_month": True, "cutoff_day": 20}
        )
    ...
    def test_due_date_after_cutoff_day(self):
        """Test if due date is shifted by +1 month when invoice date is after cutoff_day"""
